...
RSpec.describe Curator do
  ...
  describe "#find_artist_name_by_id" do
    it "can find artist name by id" do
      curator = Curator.new
      photo_1 = Photograph.new({
          id: "1",
          name: "Rue Mouffetard, Paris (Boy with Bottles)",
      ...
      expect(curator.find_artist_name_by_id("1")).to eq("Henri Cartier-Bresson")
      expect(curator.find_artist_name_by_id("2")).to eq("Ansel Adams")
      expect(curator.find_artist_name_by_id("3")).to eq("Diane Arbus")
    end
  end
