RSpec.describe 'ints and floats' do
  ...
  it 'test 9' do
    ...
    rounded = pi.round.to_i.next
    #  would expect both of the below solutions to work, but neither seems to be working; went with the above solution
    #  rounded = pi.round(half: :even)
    #  rounded = pi.round(half: :up)
